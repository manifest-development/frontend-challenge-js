...
function FormContent({
  currentStep, updateUserData, userData, confirmForm, backToPreviousStep, backToStepOne,
}) {
      ...
      <Styled.FormContentDiv>
        {currentStep === 1 ? (
          ...
          <Flex flexDirection="column" justifyContent="center" id="thankyou-page">
            ...
            <Button onClick={backToStepOne} id="form-submit-another-button">Submit Another</Button>
          </Flex>
        )}
      </Styled.FormContentDiv>
    </Container>
