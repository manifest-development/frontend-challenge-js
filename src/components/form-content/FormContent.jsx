...
function FormContent({
  ...
  const submitForm = () => {
    if (!localData.income || !localData.name) {
          ...
          currentStep === 4 && (
            ...
            >
              <div style={{ display: "flex", marginBottom: "2rem" }}>
                <img alt="Katie" src={Katie} style={{ scale: "60%" }} />
                <div
                  style={{
                    color: "white",
                    fontWeight: "200",
                    backgroundColor: "rgb(153, 158, 142",
                    borderRadius: "1rem",
                    padding: "1rem",
                  }}
                >
                  Hi,&nbsp;
                  {localData.name}, thank you for submitting the form. We will
                  check and get back to you within 2 business days.
                </div>
              </div>
              <Button onClick={backToStepOne} id="form-submit-second-button">
                Submit Another
              </Button>
            </Flex>
          )
