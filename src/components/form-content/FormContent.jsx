...
function FormContent({
  currentStep, updateUserData, userData, confirmForm, backToPreviousStep, backToStartStep,
}) {
        ...
        {currentStep === 1 ? (
          ...
          <Flex flexDirection="column" justifyContent="center" id="thankyou-page">
            <div style={{ display: 'flex', marginBottom: '2rem' }}>
              <img alt="Katie" src={Katie} style={{ scale: '50%', marginTop: '1rem' }} />
              <div style={{
                color: 'white',
                fontWeight: '200',
            ...
            <Button onClick={backToStartStep} id="form-submit-another-button">Submit Another</Button>
          </Flex>
        )}
      </Styled.FormContentDiv>
    </Container>
